...
cp target/aarch64-unknown-none/release/unix-v11-kernel dist/bin/unix-v11
...
qemu-system-aarch64 -cpu cortex-a72 -machine virt,accel=tcg -smp 4 -bios /opt/homebrew/Cellar/qemu/10.0.0/share/qemu/edk2-aarch64-code.fd \
